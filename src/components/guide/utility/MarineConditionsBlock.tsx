...
function MarineMetricGlyph({ kind, state }: { kind: MarineMetricKind; state: MetricState }) {
  ...
  return (
    <svg className="h-14 w-14 shrink-0" viewBox="0 0 64 64" fill="none" aria-hidden="true">
        ...
        <div className={`mt-5 grid items-start gap-4 ${compact ? "lg:grid-cols-[minmax(0,1.5fr)_minmax(13rem,0.5fr)]" : "lg:grid-cols-[1.1fr_0.9fr]"}`}>
          <section className="border border-[#e6d9c6] bg-white/65 p-4 sm:p-5">
            ...
            <dl className="mt-4 grid min-w-0 gap-3 sm:grid-cols-2 lg:grid-cols-3">
              <div className="border border-[#ede1cf] bg-[#fffdf8] p-3 text-center">
                <dt className="text-[0.68rem] font-bold uppercase tracking-[0.16em] text-[#b49353]">{copy.sea}</dt>
                <div className="mt-3 grid justify-items-center gap-2"><dd className="whitespace-nowrap text-xl font-semibold leading-none text-[#173f36] sm:text-2xl">{valueWithUnit(marine.seaTemperature, "°C")}</dd><MarineMetricGlyph kind="sea" state={states.sea} /></div>
              ...
              <div className="border border-[#ede1cf] bg-[#fffdf8] p-3 text-center">
                ...
                <div className="mt-3 grid justify-items-center gap-2"><dd className="whitespace-nowrap text-xl font-semibold leading-none text-[#173f36] sm:text-2xl">{valueWithUnit(marine.windSpeed, " km/h")}</dd><MarineMetricGlyph kind="wind" state={states.wind} /></div>
              ...
              <div className="border border-[#ede1cf] bg-[#fffdf8] p-3 text-center">
                ...
                <div className="mt-3 grid justify-items-center gap-2"><dd className="whitespace-nowrap text-xl font-semibold leading-none text-[#173f36] sm:text-2xl">{typeof marine.rainChance === "number" ? `${marine.rainChance}%` : "—"}</dd><MarineMetricGlyph kind="rain" state={states.rain} /></div>
              ...
              <div className="border border-[#ede1cf] bg-[#fffdf8] p-3 text-center">
                ...
                <div className="mt-3 grid justify-items-center gap-2"><dd className="whitespace-nowrap text-xl font-semibold leading-none text-[#173f36] sm:text-2xl">{valueWithUnit(marine.waveHeight, " m")}</dd><MarineMetricGlyph kind="waves" state={states.waves} /></div>
              ...
              <div className="border border-[#ede1cf] bg-[#fffdf8] p-3 text-center">
                ...
                <div className="mt-3 grid justify-items-center gap-2"><dd className="whitespace-nowrap text-xl font-semibold leading-none text-[#173f36] sm:text-2xl">{valueWithUnit(marine.swellWaveHeight, " m")}</dd><MarineMetricGlyph kind="swell" state={states.swell} /></div>
              ...
              <div className="border border-[#ede1cf] bg-[#fffdf8] p-3 text-center">
                ...
                <div className="mt-3 grid justify-items-center gap-2"><dd className="whitespace-nowrap text-xl font-semibold leading-none text-[#173f36] sm:text-2xl">{valueWithUnit(marine.swellWavePeriod, " s")}</dd><MarineMetricGlyph kind="period" state={states.period} /></div>
