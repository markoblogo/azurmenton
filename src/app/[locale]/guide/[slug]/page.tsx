...
import { GuideAuthorityPanel } from "@/components/guide/GuideAuthorityPanel";
...
import { getGuideAuthorityProfile } from "@/content/guide-authority";
...
export default async function GuideArticlePage({ params }: PageProps) {
  ...
  const authorityProfile = getGuideAuthorityProfile(article.slug, locale);
        ...
        <Container>
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_18rem]">
            ...
            <aside className="h-fit space-y-4 lg:sticky lg:top-24">
              ...
              {authorityProfile ? <GuideAuthorityPanel profile={authorityProfile} locale={locale} labels={{ author: copy.authorityAuthor, checked: copy.authorityChecked, sources: copy.authoritySources }} /> : null}
