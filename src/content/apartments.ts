...
export const apartments: Apartment[] = [
  {
    ...
    heroImage: `${seaViewImagePath}/04-open-plan-studio-layout.jpg`,
    cardImage: `${seaViewImagePath}/01-balcony-coffee-sea-view.jpg`,
    ...
    gallery: [
      {
        src: `${seaViewImagePath}/01-balcony-coffee-sea-view.jpg`,
      ...
      {
        src: `${seaViewImagePath}/02-sea-view-from-balcony.jpg`,
      ...
      {
        src: `${seaViewImagePath}/03-balcony-from-inside.jpg`,
      ...
      {
        src: `${seaViewImagePath}/04-open-plan-studio-layout.jpg`,
      ...
      {
        src: `${seaViewImagePath}/05-double-bed-balcony-access.jpg`,
      ...
      {
        src: `${seaViewImagePath}/08-comfortable-double-bed.jpg`,
      ...
      {
        src: `${seaViewImagePath}/09-kitchenette.jpg`,
      ...
      {
        src: `${seaViewImagePath}/10-bathroom-sink.jpg`,
      ...
      {
        src: `${seaViewImagePath}/14-menton-lemon-festival-view.jpg`,
      ...
      {
        src: `${seaViewImagePath}/15-building-entrance.jpg`,
