...
export const guideIntentClusters: GuideIntentCluster[] = [
  ...
  },
  {
    ...
    supportingGuideSlugs: ["fete-du-citron-menton-practical-guide", "supermarkets-in-menton", "best-souvenir-shops-menton-monaco-nice", "tennis-padel-courts-menton", "useful-numbers-emergency-contacts-menton", "public-transport-in-menton", "how-to-get-to-menton-from-nice-airport", "airports-near-menton-live-flights", "electric-car-charging-menton", "official-tourism-websites-menton-riviera", "radio-stations-menton-riviera"],
