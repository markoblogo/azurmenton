...
export const guideIntentClusters: GuideIntentCluster[] = [
  {
    ...
    supportingGuideSlugs: ["fete-du-citron-menton-practical-guide", "stay-cool-in-menton-summer", "best-ice-cream-menton", "supermarkets-in-menton", "cinemas-in-menton-nice-monaco", "theatre-opera-performing-arts-near-menton", "museums-in-menton-nice-monaco", "golf-near-menton"],
    relatedPlaceIds: ["plage-sablettes", "plage-fossan", "rue-saint-michel-menton", "koaland-menton", "cinema-eden-menton", "theatre-de-la-cite-nice", "oceanographic-museum-monaco"],
  ...
  },
  {
    ...
    supportingGuideSlugs: ["monaco-events-from-menton", "italian-riviera-day-trip-from-menton", "wine-tasting-near-menton", "theatre-opera-performing-arts-near-menton", "golf-near-menton", "mountains-snow-skiing-near-menton", "public-transport-in-menton", "menton-three-day-itinerary", "museums-in-menton-nice-monaco"],
    relatedPlaceIds: ["monaco-monte-carlo", "nice-old-town", "ventimiglia", "bordighera", "eze-village", "dolceacqua", "chateau-de-bellet", "monte-carlo-golf-club", "circolo-golf-degli-ulivi-sanremo", "opera-de-monte-carlo", "col-de-turini"],
    relatedApartmentKeys: allApartments,
  ...
  },
  {
    ...
    supportingGuideSlugs: ["best-beaches-in-menton", "menton-with-kids-family-guide", "best-ice-cream-menton", "mountains-snow-skiing-near-menton", "cinemas-in-menton-nice-monaco", "museums-in-menton-nice-monaco"],
