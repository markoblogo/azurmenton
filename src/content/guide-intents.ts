...
export const guideIntentClusters: GuideIntentCluster[] = [
  ...
  },
  {
    ...
    supportingGuideSlugs: ["monaco-events-from-menton", "italian-riviera-day-trip-from-menton", "wine-tasting-near-menton", "theatre-opera-performing-arts-near-menton", "public-transport-in-menton", "menton-three-day-itinerary", "museums-in-menton-nice-monaco"],
    relatedPlaceIds: ["monaco-monte-carlo", "nice-old-town", "ventimiglia", "bordighera", "eze-village", "dolceacqua", "chateau-de-bellet", "opera-de-monte-carlo"],
    relatedApartmentKeys: allApartments,
