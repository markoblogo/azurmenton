...
export const guideIntentClusters: GuideIntentCluster[] = [
  {
    ...
    supportingGuideSlugs: ["fete-du-citron-menton-practical-guide", "stay-cool-in-menton-summer", "best-ice-cream-menton", "supermarkets-in-menton", "cinemas-in-menton-nice-monaco", "theatre-opera-performing-arts-near-menton", "museums-in-menton-nice-monaco", "golf-near-menton", "tennis-padel-courts-menton"],
    relatedPlaceIds: ["plage-sablettes", "plage-fossan", "rue-saint-michel-menton", "koaland-menton", "tennis-municipal-la-madone", "cinema-eden-menton", "theatre-de-la-cite-nice", "oceanographic-museum-monaco"],
  ...
  },
  {
    ...
    relatedPlaceIds: ["halles-du-marche", "maison-herbin-menton", "au-pays-du-citron-menton", "u-express-menton-centre", "parking-vieille-ville-sablettes", "parking-saint-roch-menton", "parking-gare-sncf-menton", "office-tourisme-menton-riviera-merveilles", "tennis-club-de-menton", "centre-hospitalier-la-palmosa-menton", "commissariat-police-menton"],
    relatedApartmentKeys: allApartments,
  },
];
