...
export const guideIntentClusters: GuideIntentCluster[] = [
  ...
  },
  {
    ...
    supportingGuideSlugs: ["fete-du-citron-menton-practical-guide", "supermarkets-in-menton", "best-souvenir-shops-menton-monaco-nice", "best-barbershops-menton", "tennis-padel-courts-menton", "useful-numbers-emergency-contacts-menton", "public-transport-in-menton", "how-to-get-to-menton-from-nice-airport", "airports-near-menton-live-flights", "electric-car-charging-menton", "petrol-stations-menton", "public-toilets-menton", "official-tourism-websites-menton-riviera", "radio-stations-menton-riviera", "coworking-remote-work-menton", "post-offices-stamps-menton", "computer-and-phone-repair-in-menton"],
    relatedPlaceIds: ["halles-du-marche", "maison-herbin-menton", "au-pays-du-citron-menton", "u-express-menton-centre", "pharmacie-lafayette-des-jardins", "pharmacie-victoria-menton", "parking-vieille-ville-sablettes", "parking-saint-roch-menton", "parking-gare-sncf-menton", "office-tourisme-menton-riviera-merveilles", "tennis-club-de-menton", "centre-hospitalier-la-palmosa-menton", "commissariat-police-menton", "la-poste-menton-centre"],
    relatedApartmentKeys: allApartments,
  },
];
...
export const guideLinkAuditProfiles: GuideLinkAuditProfile[] = [
  ...
  { slug: "best-breakfast-menton", ignore: ["cluster"], reason: "focused breakfast guide surfaced through the Food & markets collection and linked to pastries, coffee, market and stay content" },
  { slug: "cheap-eats-menton-budget-lunch", ignore: ["cluster"], reason: "focused budget-food guide surfaced through the Food & markets collection and linked to markets, bakeries, Monaco and Nice day-trip lunch options" },
  ...
  { slug: "best-coffee-menton", ignore: ["cluster"], reason: "focused coffee guide surfaced through the Food & markets collection and linked to breakfast, bakeries, markets, practical stay and remote-work content" },
  ...
  { slug: "tea-rooms-afternoon-tea-near-menton", ignore: ["cluster"], reason: "focused tea-room guide surfaced through the Food & markets collection and linked to pastries, coffee, breakfast, Monaco and Nice day-trip content" },
  ...
  { slug: "menton-hand-drawn-postcards", ignore: ["cluster"], reason: "standalone owner artwork collection linked to art, screen-location, old-town and photo content" },
