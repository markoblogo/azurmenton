...
export const contentCollections: ContentCollection[] = [
  {
    ...
    includeGuideSlugs: ["supermarkets-in-menton"],
    priorityGuideSlugs: ["local-food-menton", "halles-du-marche-menton", "supermarkets-in-menton"],
  },
  {
  ...
  },
  {
    ...
    includeGuideSlugs: ["museums-in-menton-nice-monaco", "cinemas-in-menton-nice-monaco", "theatre-opera-performing-arts-near-menton"],
