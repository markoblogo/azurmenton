...
export const contentCollections: ContentCollection[] = [
  ...
  },
  {
    ...
    includeGuideSlugs: ["menton-without-a-car", "where-to-stay-in-menton", "supermarkets-in-menton", "best-barbershops-menton", "airports-near-menton-live-flights", "electric-car-charging-menton", "petrol-stations-menton", "public-toilets-menton", "coworking-remote-work-menton", "computer-and-phone-repair-in-menton"],
  ...
  },
  {
    ...
    categories: [],
    includeGuideSlugs: ["gyms-fitness-centres-menton", "yoga-in-menton", "saunas-spas-menton", "petanque-in-menton", "golf-near-menton", "tennis-padel-courts-menton", "best-walks-and-hikes-around-menton", "skateparks-near-menton", "cycling-bike-rental-menton", "fishing-in-menton", "air-adventures-near-menton"],
    priorityGuideSlugs: ["air-adventures-near-menton", "petanque-in-menton", "yoga-in-menton", "gyms-fitness-centres-menton", "tennis-padel-courts-menton", "golf-near-menton", "best-walks-and-hikes-around-menton", "cycling-bike-rental-menton", "skateparks-near-menton"],
  },
  {
    id: "evening-plans",
...
export const contentIntentMap: ContentIntent[] = [
  ...
  { id: "menton-bakeries", query: t("best bakeries in Menton", "meilleures boulangeries a Menton", "migliori panifici a Mentone", "найкращі пекарні в Ментоні"), collectionId: "food-and-markets", priority: "now", status: "covered", targetGuideSlug: "best-bakeries-in-menton", season: "all-year" },
  { id: "menton-kebab-falafel", query: t("kebab and falafel in Menton", "kebab et falafel a Menton", "kebab e falafel a Mentone", "кебаб і фалафель у Ментоні"), collectionId: "food-and-markets", priority: "next", status: "covered", targetGuideSlug: "kebab-shawarma-falafel-menton", season: "all-year" },
  ...
  { id: "menton-computer-phone-repair", query: t("computer and phone repair in Menton", "reparation de telephones et d'ordinateurs a Menton", "riparazione di telefoni e computer a Mentone", "ремонт телефонів і комп'ютерів у Ментоні"), collectionId: "practical-stay", priority: "now", status: "covered", targetGuideSlug: "computer-and-phone-repair-in-menton", season: "all-year" },
  ...
  { id: "menton-air-adventures", query: t("air adventures near Menton", "activites aeriennes pres de Menton", "avventure aeree vicino a Mentone", "повітряні пригоди біля Ментона"), collectionId: "sport-and-outdoors", priority: "next", status: "covered", targetGuideSlug: "air-adventures-near-menton", season: "all-year" },
